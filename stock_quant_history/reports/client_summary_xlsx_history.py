...
class InventorySummary(models.AbstractModel):
    _name = "report.stock_quant_history.inventory_summary_xlsx"
    ...
    def generate_xlsx_report(self, workbook, data, records):
        ...
        for customer_name, moves in grouped_records.items():
            ...
            sheet.merge_range('F3:G3', (records[0].inventory_date + timedelta(hours=8)).strftime("%Y-%m-%d %H:%M"), datetime_format)
